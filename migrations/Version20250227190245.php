 ...
 */
final class Version20250227190245 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE puzzle (id INT AUTO_INCREMENT NOT NULL, game_id INT DEFAULT NULL, final_image VARCHAR(255) NOT NULL, pieces JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', INDEX IDX_22A6DFDFE48FD905 (game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
