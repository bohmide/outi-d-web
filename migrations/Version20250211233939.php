 ...
 */
final class Version20250211233939 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE chapitre ADD quiz_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE chapitre ADD CONSTRAINT FK_8C62B025853CD175 FOREIGN KEY (quiz_id) REFERENCES quiz (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8C62B025853CD175 ON chapitre (quiz_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_8C62B025853CD175 ON chapitre');
        $this->addSql('ALTER TABLE chapitre DROP quiz_id');
