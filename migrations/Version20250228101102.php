 ...
 */
final class Version20250228101102 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE competition (id INT AUTO_INCREMENT NOT NULL, organisation_id INT NOT NULL, nom_comp VARCHAR(255) NOT NULL, nom_entreprise VARCHAR(255) NOT NULL, date_debut DATE DEFAULT NULL, date_fin DATE DEFAULT NULL, description VARCHAR(255) NOT NULL, fichier VARCHAR(255) NOT NULL, INDEX IDX_B50A2CB19E6B1585 (organisation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE evenements (id INT AUTO_INCREMENT NOT NULL, genre_id INT NOT NULL, nom_event VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, date_event DATE NOT NULL, nbr_members INT DEFAULT NULL, image_path VARCHAR(255) DEFAULT NULL, date_creation DATE NOT NULL, INDEX IDX_E10AD4004296D31F (genre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE event_genre (id INT AUTO_INCREMENT NOT NULL, nom_genre VARCHAR(255) NOT NULL, nbr INT DEFAULT NULL, image_path VARCHAR(255) DEFAULT NULL, date_creation DATE NOT NULL, UNIQUE INDEX UNIQ_C24B82D429A8AF6D (nom_genre), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE question (id INT AUTO_INCREMENT NOT NULL, quiz_id INT NOT NULL, question VARCHAR(255) NOT NULL, type VARCHAR(20) NOT NULL, INDEX IDX_B6F7494E853CD175 (quiz_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE quiz_kids (id INT AUTO_INCREMENT NOT NULL, challenge_id INT DEFAULT NULL, question VARCHAR(255) NOT NULL, options JSON NOT NULL COMMENT \'(DC2Type:json)\', correct_answer VARCHAR(255) NOT NULL, media VARCHAR(255) DEFAULT NULL, level VARCHAR(255) NOT NULL, score VARCHAR(255) NOT NULL, updated_at DATETIME DEFAULT NULL, genre VARCHAR(255) NOT NULL, INDEX IDX_88092DCF98A21AC6 (challenge_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sponsors (id INT AUTO_INCREMENT NOT NULL, nom_sponsor VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, image_path VARCHAR(255) DEFAULT NULL, date_creation DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
