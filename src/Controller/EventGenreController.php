...
{
    #[Route('/event/genre', name: 'app_event_genre')]
    ...
    // show
    #[Route('/event/showEventGenres', name: 'app_show_event_genre')]
    ...
    // update
    #[Route('/event/updateGenre/{id}', name: 'app_update_event_genre')]
    ...
    // delete
    #[Route('/event/deleteEventGenres/{id}', name: 'app_delete_event_genre')]
