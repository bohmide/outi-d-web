...
final class EventGenreController extends AbstractController
{
    ...
    #[Route('/events/addGenre', name: 'app_front_add_event_genre')]
    public function addGenre(Request $request, ManagerRegistry $mr, EventGenreRepository $egr, EntityManagerInterface $entityManager, SluggerInterface $slugger): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $mr->getManager()->flush();
            return $this->redirectToRoute('app_front_show_event_genre');
        }
    ...
    // show
    #[Route('/events/showEventGenres', name: 'app_front_show_event_genre')]
    ...
    // update
    #[Route('/events/updateGenre/{id}', name: 'app_front_update_event_genre')]
